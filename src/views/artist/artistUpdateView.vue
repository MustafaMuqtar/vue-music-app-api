  ...
  <div class="container bg-dark text-white">
    <form enctype="multipart/form-data " @submit.prevent>
      <div class="mb-4">
        ...
        <input
          v-model="artistService.fullName"
          type="text"
          class="form-control"
      ...
      <div class="mb-4 pb-4">
        ...
        />
        <input
          @change="artistService.upploadImage"
          type="file"
          id="file-field"
          style="display: none"
          class="form-control"
      ...
      <button
        type="submit"
        @click="artistService.updateArtist()"
        class="btn btn-info me-5"
      >
        <span v-if="artistService.isUpdating"
          ><span
      ...
      <button
        type="button"
        @click="artistService.artistDelete()"
        class="btn btn-danger"
      >
        <span v-if="artistService.isDeleting"
          ><span
            class="spinner-grow spinner-grow-sm"
            role="status"
            aria-hidden="true"
